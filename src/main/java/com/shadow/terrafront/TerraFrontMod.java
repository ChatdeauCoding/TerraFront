...
@Mod(TerraFrontMod.MODID)
public class TerraFrontMod {
    public static final String MODID = "terrafront";
    public static final Logger LOGGER = LogUtils.getLogger();


    public TerraFrontMod(IEventBus modEventBus, ModContainer modContainer) {
